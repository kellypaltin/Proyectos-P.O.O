...
public class Control_tab_Factura_C {
    ...
    public void llenar_Tabla (Factura_Compra ob_cl){
    ...
    public void consultar(){
        ...
        Factura_Compra ob_cl = new Factura_Compra();
        ResultSet matris_resultad = obj_conexcion.consultar("select * from factura_compra");
        try{
